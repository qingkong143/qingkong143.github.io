...
.article-inner {
  ...
  &:before {
    ...
    inset: 0;
    pointer-events: none;
    background: linear-gradient(145deg, rgba(255, 255, 255, 0.1), rgba(255, 187, 118, 0.1) 48%, rgba(255, 255, 255, 0.04));
  }
...
.article-header {
  padding: 0 article-padding + 16px 20px;
...
.article-entry {
  ...
  font-weight: var(--glass-card-font-weight);
...
.article-tag-list-link, .article-comment-link, .article-visitor-link {
  color: var(--red-1);
