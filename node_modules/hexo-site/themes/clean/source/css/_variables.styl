...
:root {
  ...
  --highlight-current-line: unquote(light-highlight-current-line);
  ...
  --glass-card-opacity: hexo-config('glass_card.opacity') || 0.22;
  --glass-card-blur: hexo-config('glass_card.blur') || 36px;
  --glass-card-saturate: hexo-config('glass_card.saturate') || 145%;
  --glass-card-bg: unquote('rgba(255, 255, 255, var(--glass-card-opacity))');
  --glass-card-text: unquote('' + (hexo-config('glass_card.text_color') || 'rgba(255, 255, 255, 0.94)'));
  --glass-card-title: unquote('' + (hexo-config('glass_card.title_color') || '#fff'));
  --glass-card-font-weight: hexo-config('glass_card.font_weight') || 600;
...
[data-theme='dark'] {
  &:root {
    ...
    --highlight-current-line: unquote(dark-highlight-current-line);
