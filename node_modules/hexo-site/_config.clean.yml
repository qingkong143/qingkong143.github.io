...
header_hero:
  image: # optional override for the home hero visual, e.g. /images/banner.webp
...
# Home post card display
# enable keeps the original auto excerpt; false only shows manual front-matter summary/description/brief.
postcard: false
...
bangumi:
  enable: true
  title: 追番列表
  subtitle: 把喜欢的作品、补番进度和观后感收进同一页。
  description: 生命不息，追番不止！
  # 此处仅控制追番页展示文案，不维护具体条目
  # bangumi 条目请统一维护在 bangumi 页面 front-matter: bangumi
  # 可选实验性 Bilibili 自动拉取请在 bangumi 页面 front-matter: bilibili 配置
